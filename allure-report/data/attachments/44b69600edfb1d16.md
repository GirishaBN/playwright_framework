...
- Location: tests\LoginPageFix.spec.ts:16:1
        ...
        - generic [ref=e87]:
          ...
          - generic [ref=e91]:
            - generic [ref=e92]:
              ...
              - textbox "E-Mail Address" [ref=e94]: girisha@gmail.com
            - generic [ref=e95]:
              - generic [ref=e96]: Password
              - textbox "Password" [ref=e97]: Test@1234
...
```ts
  ...
  9  |     const pageTitle = await loginPage.getLoginPageTitle();
  10 |     expect(pageTitle).toBe('Account Login');
  11 | })
  12 | test('forgot password test', async ({loginPage }) => {
  13 |     expect(await loginPage.isForgotPasswordLinkExistsOrNot()).toBeTruthy();
  14 | })
  15 | 
  16 | test('User is able to login to application test', async ({loginPage, homePage}) => {
  17 |     await loginPage.doLogin('girisha@gmail.com', 'Test@1234');
  18 |     expect.soft(await homePage.isLogoutLinkExists()).toBeTruthy;
> 19 |     expect.soft(await homePage.getHomePageTitle()).toBe('My Account');
     |                                                    ^ Error: expect(received).toBe(expected) // Object.is equality
  20 |     
  21 | })
  22 | 
