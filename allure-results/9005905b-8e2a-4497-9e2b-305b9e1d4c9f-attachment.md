...
- Name: RegisterPageFix.spec.ts >> verify user is able to fill the register form test:Revamma and KM
- Location: tests\RegisterPageFix.spec.ts:14:5

# Error details

```
Error: locator.check: SyntaxError: Failed to execute 'querySelectorAll' on 'Document': 'input[name="newsletter"][value=1]' is not a valid selector.
